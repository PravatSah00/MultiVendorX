...
namespace MultiVendorX\Install;
...
class Installer {
    ...
    public function __construct() {
        ...
        if(!mvx_get_option('dc_product_vendor_plugin_installed') && apply_filters('mvx_enable_setup_wizard', true)){
            set_transient( '_mvx_activation_redirect', 1, 30 * MINUTE_IN_SECONDS );
        }
    ...
    function mvx_plugin_tables_install() {
        ...
        $create_tables_query[] = "CREATE TABLE IF NOT EXISTS `" . $wpdb->prefix . "mvx_commission` (
